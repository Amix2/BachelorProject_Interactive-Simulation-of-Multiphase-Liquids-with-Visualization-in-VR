...
lin_string = string[ string.index('LIN ==================== LIN') + len('LIN ==================== LIN')+2 : string.index('COPY ==================== COPY')]
for part_str in sph_string.split('),'):
    if(part_str.startswith(' ( ')):
        part_str = part_str[3:]
        values = part_str.split(', ')
...
#print(part_count, sort_values)
#pyplot.xlabel("Numer iteracji")
#pyplot.ylabel("Funkcja kosztu")
